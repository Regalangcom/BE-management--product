...
exports.register = (email, password, isAdmin, name, lastname) => {
                    ...
                    if (results.length > 0) {
                        ...
                        bcrypt.hash(password, 10, (hashErr, hashedPassword) => {
                            if (hashErr) {
                                ...
                                pool.query(
                                    "INSERT INTO users (email, password, isAdmin, name, lastname) VALUES (?,?,?,?,?);",
                                    [email, hashedPassword, isAdmin, name, lastname],
                                    (insertErr, result) => {
                                        if (insertErr) {
                                            reject(insertErr);
                                        } else {
